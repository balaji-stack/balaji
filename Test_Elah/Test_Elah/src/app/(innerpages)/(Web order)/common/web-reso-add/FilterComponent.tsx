...
const FilterComponent = (props: Props) => {
    ...
    const filterFields = [
        ...
        {
            fieldType: 'date', colArr: [2, 2, 3, 6, 6, 6], label: 'Data DDT da', field: 'resi_datefrom', value: filter.resi_datefrom,
            placeholder: null, onchangeHandler: onchangeHandler, clickHandler: null, options: null
        },

        {
            fieldType: 'date', colArr: [2, 2, 3, 6, 6, 6], label: 'Data DDT a', field: 'resi_dateto', value: filter.resi_dateto,
            placeholder: null, onchangeHandler: onchangeHandler, clickHandler: null, options: null
        },
