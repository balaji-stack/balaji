...
const FilterComponent = (props: Props) => {
    ...
    const filterFields = [
        ...
        {
            fieldType: 'select', colArr: [4, 4, 6, 12, 12, 12], label: 'Autorizzazione', field: 'autorizza', value: filter.autorizza,
        ...
        {
            fieldType: 'date', colArr: [2, 2, 3, 6, 12, 12], label: 'Dalla data rev.', field: 'promoCreatedFromDate', value: filter.promoCreatedFromDate,
            placeholder: null, onchangeHandler: onchangeHandler, clickHandler: null, options: null
        },
        {
            fieldType: 'date', colArr: [2, 2, 3, 6, 12, 12], label: 'Alla data  rev.', field: 'promoCreatedToDate', value: filter.promoCreatedToDate,
            placeholder: null, onchangeHandler: onchangeHandler, clickHandler: null, options: null
        }]
    return (
        <section>
