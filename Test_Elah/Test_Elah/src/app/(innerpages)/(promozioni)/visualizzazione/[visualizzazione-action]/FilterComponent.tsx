...
const FilterComponent = (props: Props) => {
    ...
    const filterFields = [
        ...
        {
            fieldType: 'inputSearch', colArr: [4, 4, 6, 12, 12, 12], label: 'Cliente', field: 'tclientname', value: filter.tclientname,
            placeholder: null, onchangeHandler: onchangeHandler, clickHandler:  ()=>{showClienteHandler()}, options: null
        },
        {
            fieldType: 'date', colArr: [2, 2, 3, 6, 6, 6], label: 'Dalla data rev.', field: 'txtPromoCreatedDate', value: filter.promoCreatedFromDate,
            placeholder: null, onchangeHandler: onchangeHandler, clickHandler: null, options: null
        },
        {
            fieldType: 'date', colArr: [2, 2, 3, 6, 6, 6], label: 'Alla data  rev.', field: 'txtPromoCreatedToDate', value: filter.promoCreatedToDate,
            placeholder: null, onchangeHandler: onchangeHandler, clickHandler: null, options: null
        }]
    return (
        <section>
