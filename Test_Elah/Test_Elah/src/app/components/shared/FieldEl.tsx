...
type Props = {
    ...
    field: string;
    onchangeHandler: Function | null;
    options: any | null;

}


const FieldEl = (props: Props) => {
    ...
    return (
        <div className={`${colGrid}`}>
            <div className={`${fieldType == 'viewText' ? 'each_content' : 'form-group'}`}>
                <label>
                    {label} {fieldType == 'viewText' && <i>:</i>}
                </label>
                {FieldTag}
            </div>
        </div>
